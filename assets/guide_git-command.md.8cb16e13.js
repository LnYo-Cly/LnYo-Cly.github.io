import{_ as s,o as n,c as a,X as p}from"./chunks/framework.e702791a.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"guide/git-command.md","filePath":"guide/git-command.md","lastUpdated":1691834853000}'),l={name:"guide/git-command.md"},e=p(`<div class="language-bash vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 添加上游仓库地址  git@github.com:LnYo-Cly/elu-design.git</span></span>
